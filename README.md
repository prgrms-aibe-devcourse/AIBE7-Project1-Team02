...
사용자의 성향, 예산, 여행 스타일을 분석해 개인에게 최적화된 여행지와 여행 일정을 추천하는 AI 기반 여행 플랫폼입니다.
...
```text
추천 점수 = 성향 적합도 50% + 예산 적합도 20% + 계절&날씨 적합도 15% + 동행자 적합도 15%
```
...
AI 환각을 줄이기 위해 TourAPI 등 신뢰 가능한 실제 관광 데이터를 먼저 조회하고, AI에는 실제 데이터와 사용자 조건을 함께 전달합니다.
